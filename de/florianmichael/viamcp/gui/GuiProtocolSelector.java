...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            Gui.drawCenteredString(this.mc.fontRendererObj, (String)(ViaLoadingBase.PROTOCOLS.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) == i ? EnumChatFormatting.GREEN.toString() + String.valueOf((Object)EnumChatFormatting.BOLD) : EnumChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), this.width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
