...
extends Util {
    ...
    public static int getBucketSlot() {
        ...
        for (int i = 36; i < 45; ++i) {
            ItemBucket itemSlot;
            if (InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack() == null || !(InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem() instanceof ItemBucket) || (itemSlot = (ItemBucket)InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem()) != Items.water_bucket) continue;
            item = i - 36;
        }
        return item;
    }
    ...
    public static int getCobwebSlot() {
        ...
        for (int i = 36; i < 45; ++i) {
            ItemBlock block;
            if (InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack() == null || !(InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem() instanceof ItemBlock) || (block = (ItemBlock)InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem()).getBlock() != Blocks.web) continue;
            item = i - 36;
        }
        return item;
    }
    ...
    public static int getEmptyBucketSlot() {
        ...
        int stacksize = 0;
        for (int i = 36; i < 45; ++i) {
            if (InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack() == null || InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem() != Items.bucket) continue;
            item = i - 36;
            stacksize = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot((int)i).getStack().stackSize;
        }
        return item;
    ...
    public static ItemStack getBucketSlotInventory() {
        ...
        int stacksize = 0;
        for (int i = 9; i < 45; ++i) {
            if (InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack() == null || InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack().getItem() != Items.water_bucket) continue;
            item = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack();
            stacksize = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot((int)i).getStack().stackSize;
        }
        return item;
    ...
    public static boolean isBestArmor(ItemStack stack, int type) {
        ...
        for (int i = 5; i < 45; ++i) {
            ...
            if (!(InventoryUtils.getProtection(itemStack) > prot) || !is.getUnlocalizedName().contains(strType)) continue;
            return false;
        }
        return true;
    }
    ...
    public static boolean isBadStack(ItemStack is, boolean preferSword, boolean keepTools) {
        for (int type = 1; type < 5; ++type) {
            ...
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(4 + type).getHasStack() || !InventoryUtils.isBestArmor(InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(4 + type).getStack(), type) || !InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(4 + type).getStack().getUnlocalizedName().contains(strType) || !is.getUnlocalizedName().contains(strType)) continue;
            return true;
        }
    ...
    public static float bestWeaponSkill() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack()) continue;
            ItemStack is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack();
            float toolDamage = InventoryUtils.getItemDamage(is);
            if (!(f >= itemDamage)) continue;
    ...
    public static float bestSwordSkill() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            ItemStack is;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack() || !((is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemSword)) continue;
            float swordDamage = InventoryUtils.getItemDamage(is);
            if (!(f >= itemDamage)) continue;
            itemDamage = InventoryUtils.getItemDamage(is);
        }
        return itemDamage;
    ...
    public static float bestBowSkill() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            ItemStack is;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack() || !((is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemBow)) continue;
            float bowDamage = InventoryUtils.getBowDamage(is);
            if (!(f >= itemDamage)) continue;
    ...
    public static float bestAxeSkill() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            ItemStack is;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack() || !((is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemAxe)) continue;
            float toolSkill = InventoryUtils.getToolRating(is);
            if (!(f >= itemSkill)) continue;
    ...
    public static float bestPickSkill() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            ItemStack is;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack() || !((is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemPickaxe)) continue;
            float toolSkill = InventoryUtils.getToolRating(is);
            if (!(f >= itemSkill)) continue;
            itemSkill = InventoryUtils.getToolRating(is);
        }
    ...
    public static float bestShovelSkill() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            ItemStack is;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack() || !((is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemSpade)) continue;
            float toolSkill = InventoryUtils.getToolRating(is);
            if (!(f >= itemSkill)) continue;
            itemSkill = InventoryUtils.getToolRating(is);
        }
    ...
    public static ItemStack bestWeapon() {
        ...
        for (int i = 9; i < 45; ++i) {
            float f;
            ItemStack is;
            if (!InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getHasStack() || !((is = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack()).getItem() instanceof ItemSword) && !(is.getItem() instanceof ItemAxe) && !(is.getItem() instanceof ItemPickaxe)) continue;
            float toolDamage = InventoryUtils.getItemDamage(is);
            if (!(f >= itemDamage)) continue;
            itemDamage = InventoryUtils.getItemDamage(is);
            bestWeapon = is;
    ...
    public static float getToolMaterialRating(ItemStack itemStack, boolean checkForDamage) {
        ...
        if (is instanceof ItemSword) {
            ...
            switch (((ItemPickaxe)is).getToolMaterialName()) {
                ...
                case "IRON": {
                    rating = checkForDamage ? 4.0f : 40.0f;
                    break;
                }
                case "EMERALD": {
                    rating = checkForDamage ? 5.0f : 50.0f;
                }
            }
    ...
    public static void openInv(boolean silent) {
        if (silent && !isInventoryOpen && !(InventoryUtils.mc.currentScreen instanceof GuiInventory)) {
    ...
    public static void closeInv(boolean silent) {
        if (silent && isInventoryOpen && !(InventoryUtils.mc.currentScreen instanceof GuiInventory)) {
            PacketUtils.sendSilentPacket(new C0DPacketCloseWindow(InventoryUtils.mc.thePlayer.inventoryContainer.windowId));
    ...
    public static int findBlock() {
        for (int i = 36; i < 45; ++i) {
            Block block;
            ItemStack item = InventoryUtils.mc.thePlayer.inventoryContainer.getSlot(i).getStack();
    ...
    public static boolean isBlock(ItemStack itemStack) {
        ...
        if (item instanceof ItemBlock) {
            return InventoryUtils.isContainerBlock((ItemBlock)item);
        }
        return false;
    }
