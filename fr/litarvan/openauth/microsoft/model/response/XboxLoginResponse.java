...
public class XboxLoginResponse {
    ...
    public XboxLoginResponse(String IssueInstant, String NotAfter, String Token2, XboxLiveLoginResponseClaims DisplayClaims2) {
        this.IssueInstant = IssueInstant;
        this.NotAfter = NotAfter;
        this.Token = Token2;
        this.DisplayClaims = DisplayClaims2;
    }
