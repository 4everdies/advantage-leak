...
extends EntityAITarget {
    ...
    public EntityAINearestAttackableTarget(EntityCreature creature, Class<T> classTarget, int chance, boolean checkSight, boolean onlyNearby, final Predicate<? super T> targetSelector) {
        ...
        this.targetEntitySelector = new Predicate<T>(){
            final /* synthetic */ EntityAINearestAttackableTarget this$0;
            {
                this.this$0 = this$0;
            }
            ...
            public boolean apply(T p_apply_1_) {
                ...
                if (p_apply_1_ instanceof EntityPlayer) {
                    double d0 = this.this$0.getTargetDistance();
                    ...
                    if ((double)((Entity)p_apply_1_).getDistanceToEntity(this.this$0.taskOwner) > d0) {
                        return false;
                    }
                }
                return this.this$0.isSuitableTarget((EntityLivingBase)p_apply_1_, false);
            }
        };
    }
