...
import cc.advantage.api.events.impl.game.MinMotionEvent;
...
extends Entity {
    ...
    protected void jump() {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            ...
            if (this.isSprinting()) {
                ...
                if (SprintModule.omni.getValue().booleanValue() && Advantage.INSTANCE.getModuleManager().getModule(SprintModule.class).isEnabled() && mc.thePlayer.isSprinting()) {
                    f = (float)(MovementUtils.direction() * 57.29577951308232);
                    f *= (float)Math.PI / 180;
                }
    ...
    public void onUpdate() {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            yaw = RotationProcess.rotations.x;
        }
    ...
    public void onLivingUpdate() {
        ...
        if (this == Minecraft.getMinecraft().thePlayer) {
            MinMotionEvent minimumMotionEvent = new MinMotionEvent(minimumMotion);
            Advantage.INSTANCE.getEventBus().post(minimumMotionEvent);
