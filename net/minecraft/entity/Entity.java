...
implements ICommandSender {
    ...
    public void onUpdate() {
        ...
        Vec3 vec3 = new Vec3(this.lastTickPosX, this.lastTickPosY, this.lastTickPosZ);
        if (this.getPositionVector().distanceTo(vec3) > 0.1) {
            this.moved = true;
        }
        this.onEntityUpdate();
    }
    ...
    public void onEntityUpdate() {
        ...
        Advantage.INSTANCE.getEventBus().post(new LivingUpdateEvent(this));
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        if (player) {
            StrafeEvent event = new StrafeEvent(forward, strafe, friction, this.movementYaw);
        ...
        if (player) {
            PostStrafeEvent event = new PostStrafeEvent();
            Advantage.INSTANCE.getEventBus().post(event);
        }
    }
    ...
    public float getCollisionBorderSize() {
        return ViaLoadingBase.getInstance().getTargetVersion().newerThan(ProtocolVersion.v1_8) ? 0.0f : 0.1f;
    }
