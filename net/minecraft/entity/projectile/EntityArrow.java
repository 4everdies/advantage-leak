    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (movingobjectposition1 == null || !((d1 = vec31.squareDistanceTo(((MovingObjectPosition)movingobjectposition1).hitVec)) < d0) && d0 != 0.0) continue;
                entity = entity1;
                d0 = d1;
            }
            if (entity != null) {
            ...
            if (movingobjectposition != null && movingobjectposition.entityHit != null && (entity1 = movingobjectposition.entityHit) instanceof EntityPlayer) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, l)) {
                        movingobjectposition1 = movingobjectposition.entityHit;
                        if (movingobjectposition1 instanceof EntityLivingBase) {
                            float f7;
                            EntityLivingBase entitylivingbase = (EntityLivingBase)movingobjectposition1;
