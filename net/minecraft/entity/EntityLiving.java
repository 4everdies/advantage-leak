        ...
        block7: {
            block8: {
                block11: {
                    block9: {
                        block10: {
                            itemstack = itemEntity.getEntityItem();
                            i = EntityLiving.getArmorPosition(itemstack);
                            if (i <= -1) break block7;
                            flag = true;
                            itemstack1 = this.getEquipmentInSlot(i);
                            if (itemstack1 == null) break block8;
                            if (i != 0) break block9;
                            if (!(itemstack.getItem() instanceof ItemSword) || itemstack1.getItem() instanceof ItemSword) break block10;
                            flag = true;
                            break block8;
                        }
                        var10_6 = itemstack.getItem();
                        if (!(var10_6 instanceof ItemSword)) ** GOTO lbl-1000
                        itemsword = (ItemSword)var10_6;
                        var10_6 = itemstack1.getItem();
                        if (var10_6 instanceof ItemSword) {
                            itemsword1 = (ItemSword)var10_6;
                            flag = itemsword.getDamageVsEntity() != itemsword1.getDamageVsEntity() ? itemsword.getDamageVsEntity() > itemsword1.getDamageVsEntity() : itemstack.getMetadata() > itemstack1.getMetadata() || itemstack.hasTagCompound() != false && itemstack1.hasTagCompound() == false;
                        } else lbl-1000:
                        // 2 sources

                        {
                            flag = itemstack.getItem() instanceof ItemBow && itemstack1.getItem() instanceof ItemBow ? itemstack.hasTagCompound() != false && itemstack1.hasTagCompound() == false : false;
                        }
                        break block8;
                    }
                    if (!(itemstack.getItem() instanceof ItemArmor) || itemstack1.getItem() instanceof ItemArmor) break block11;
                    flag = true;
                    break block8;
                }
                var8_8 = itemstack.getItem();
                if (!(var8_8 instanceof ItemArmor)) ** GOTO lbl-1000
                itemarmor = (ItemArmor)var8_8;
                var8_8 = itemstack1.getItem();
                if (var8_8 instanceof ItemArmor) {
                    itemarmor1 = (ItemArmor)var8_8;
                    flag = itemarmor.damageReduceAmount != itemarmor1.damageReduceAmount ? itemarmor.damageReduceAmount > itemarmor1.damageReduceAmount : itemstack.getMetadata() > itemstack1.getMetadata() || itemstack.hasTagCompound() != false && itemstack1.hasTagCompound() == false;
                } else lbl-1000:
                // 2 sources
