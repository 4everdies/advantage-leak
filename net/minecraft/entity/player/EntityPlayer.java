...
extends EntityLivingBase {
            ...
            if (f > 0.0f || f1 > 0.0f) {
                ...
                if (flag2) {
                    ...
                    if (i > 0) {
                        ...
                        HitSlowDownEvent hitSlowDown = new HitSlowDownEvent(0.6, false);
                        Advantage.INSTANCE.getEventBus().post(hitSlowDown);
    ...
    public float getEyeHeight() {
        if (this instanceof EntityPlayerSP) {
            return ViaMCPFixes.lerp(ViaMCPFixes.lastEyeHeight, ViaMCPFixes.eyeHeight, Util.mc.timer.renderPartialTicks);
        }
        float f = 1.62f;
        if (this.isPlayerSleeping()) {
            f = 0.2f;
