...
public class EntityTrackerEntry {
    ...
    public void updatePlayerList(List<EntityPlayer> players) {
        ...
        if ((entity = this.trackedEntity) instanceof EntityItemFrame) {
        ...
        if (playerMP != this.trackedEntity) {
            if (this.func_180233_c(playerMP)) {
                if (!this.trackingPlayers.contains(playerMP) && (this.isPlayerWatchingThisChunk(playerMP) || this.trackedEntity.forceSpawn)) {
                    ...
                    if ((object = this.trackedEntity) instanceof EntityPlayer && (entityplayer = (EntityPlayer)object).isPlayerSleeping()) {
                        playerMP.playerNetServerHandler.sendPacket(new S0APacketUseBed(entityplayer, new BlockPos(this.trackedEntity)));
                    }
                    if ((object = this.trackedEntity) instanceof EntityLivingBase) {
    ...
    private Packet createSpawnPacket() {
        Object s0epacketspawnobject1;
        Object s0epacketspawnobject2;
        Entity entity;
        ...
        Entity entity2 = this.trackedEntity;
        if (entity2 instanceof EntityMinecart) {
            EntityMinecart entityminecart = (EntityMinecart)entity2;
        ...
        if (entity instanceof EntityFireball) {
            ...
            ((S0EPacketSpawnObject)s0epacketspawnobject2).setSpeedX((int)(entityfireball.accelerationX * 8000.0));
            ((S0EPacketSpawnObject)s0epacketspawnobject2).setSpeedY((int)(entityfireball.accelerationY * 8000.0));
            ((S0EPacketSpawnObject)s0epacketspawnobject2).setSpeedZ((int)(entityfireball.accelerationZ * 8000.0));
        ...
        s0epacketspawnobject2 = this.trackedEntity;
        if (s0epacketspawnobject2 instanceof EntityFallingBlock) {
            EntityFallingBlock entityfallingblock = (EntityFallingBlock)s0epacketspawnobject2;
        ...
        s0epacketspawnobject2 = this.trackedEntity;
        if (s0epacketspawnobject2 instanceof EntityItemFrame) {
            EntityItemFrame entityitemframe = (EntityItemFrame)s0epacketspawnobject2;
            s0epacketspawnobject1 = new S0EPacketSpawnObject(this.trackedEntity, 71, entityitemframe.facingDirection.getHorizontalIndex());
            BlockPos blockpos1 = entityitemframe.getHangingPosition();
            ((S0EPacketSpawnObject)s0epacketspawnobject1).setX(MathHelper.floor_float(blockpos1.getX() * 32));
            ((S0EPacketSpawnObject)s0epacketspawnobject1).setY(MathHelper.floor_float(blockpos1.getY() * 32));
            ((S0EPacketSpawnObject)s0epacketspawnobject1).setZ(MathHelper.floor_float(blockpos1.getZ() * 32));
            return s0epacketspawnobject1;
        }
        s0epacketspawnobject1 = this.trackedEntity;
        if (s0epacketspawnobject1 instanceof EntityLeashKnot) {
            EntityLeashKnot entityleashknot = (EntityLeashKnot)s0epacketspawnobject1;
