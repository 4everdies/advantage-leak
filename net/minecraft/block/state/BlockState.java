    ...
    extends BlockStateBase {
        ...
        public <T extends Comparable<T>, V extends T> IBlockState withProperty(IProperty<T> property, V value) {
            ...
            if (!property.getAllowedValues().contains(value)) {
                throw new IllegalArgumentException("Cannot set property " + String.valueOf(property) + " to " + String.valueOf(value) + " on block " + String.valueOf(Block.blockRegistry.getNameForObject(this.block)) + ", it is not an allowed value");
            }
