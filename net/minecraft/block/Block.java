...
public class Block {
    ...
    public static EnumFacing getFacingDirection(BlockPos pos) {
        ...
        return (rayResult = mc.theWorld.rayTraceBlocks(new Vec3(mc.thePlayer.posX, mc.thePlayer.posY + (double)mc.thePlayer.getEyeHeight(), mc.thePlayer.posZ), new Vec3((double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5))) != null ? rayResult.sideHit : direction;
    }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        Advantage.INSTANCE.getEventBus().post(blockCollideEvent);
