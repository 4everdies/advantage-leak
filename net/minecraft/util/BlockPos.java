...
extends Vec3i {
    ...
    public boolean equalsVector(Vector3d vec) {
        return Math.floor(vec.getX()) == (double)this.getX() && Math.floor(vec.getY()) == (double)this.getY() && Math.floor(vec.getZ()) == (double)this.getZ();
    }
    ...
    extends BlockPos {
        ...
        public MutableBlockPos move(int xDist, int yDist, int zDist) {
