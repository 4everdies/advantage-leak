...
extends Container {
    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player) {
        ...
        this.addSlotToContainer(new Slot(this, this.outputSlot, 2, 134, 47){
            final /* synthetic */ ContainerRepair this$0;
            {
                this.this$0 = this$0;
            ...
            public boolean canTakeStack(EntityPlayer playerIn) {
                return (playerIn.capabilities.isCreativeMode || playerIn.experienceLevel >= this.this$0.maximumCost) && this.this$0.maximumCost > 0 && this.getHasStack();
            }

            @Override
            public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
                if (!playerIn.capabilities.isCreativeMode) {
                    playerIn.addExperienceLevel(-this.this$0.maximumCost);
                }
                this.this$0.inputSlots.setInventorySlotContents(0, null);
                if (this.this$0.materialCost > 0) {
                    ItemStack itemstack = this.this$0.inputSlots.getStackInSlot(1);
                    if (itemstack != null && itemstack.stackSize > this.this$0.materialCost) {
                        itemstack.stackSize -= this.this$0.materialCost;
                        this.this$0.inputSlots.setInventorySlotContents(1, itemstack);
                    } else {
                        this.this$0.inputSlots.setInventorySlotContents(1, null);
                    }
                } else {
                    this.this$0.inputSlots.setInventorySlotContents(1, null);
                }
