...
extends World {
    ...
    public void doVoidFogParticles(int posX, int posY, int posZ) {
        ...
        boolean flag = this.mc.playerController.getCurrentGameType() == WorldSettings.GameType.CREATIVE && itemstack != null && Block.getBlockFromItem(itemstack.getItem()) == Blocks.barrier || Advantage.INSTANCE.getModuleManager().getModule(BarrierVisionModule.class).isEnabled();
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        crashreportcategory.addCrashSectionCallable("Forced entities", new Callable<String>(){
            ...
            @Override
            public String call() {
                return WorldClient.this.entityList.size() + " total; " + String.valueOf(WorldClient.this.entityList);
            }
        });
        crashreportcategory.addCrashSectionCallable("Retry entities", new Callable<String>(){
            ...
            @Override
            public String call() {
                return WorldClient.this.entitySpawnQueue.size() + " total; " + String.valueOf(WorldClient.this.entitySpawnQueue);
            }
        });
