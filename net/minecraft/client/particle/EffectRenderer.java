...
public class EffectRenderer {
    ...
    public void addEffect(EntityFX effect) {
        if (effect != null && (!(effect instanceof EntityFirework.SparkFX) || Config.isFireworkParticles())) {
            ...
            if (this.fxLayers[i][j].size() >= this.limitParticle(4000)) {
    ...
    private int limitParticle(int original) {
        boolean limit = Advantage.INSTANCE.getModuleManager().getModule(FpsEnhancerModule.class).isEnabled() && FpsEnhancerModule.reduceParticles.getValue() != false;
    ...
    private void tickParticle(final EntityFX particle) {
        try {
            ...
            crashreportcategory.addCrashSectionCallable("Particle", new Callable<String>(){
                final /* synthetic */ EffectRenderer this$0;
                {
                    this.this$0 = this$0;
                }
    ...
    public void addBlockHitEffects(BlockPos p_addBlockHitEffects_1_, MovingObjectPosition p_addBlockHitEffects_2_) {
        ...
        if (iblockstate != null && !(flag = false)) {
