...
implements INetHandlerPlayClient {
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            long i = 1000L * (long)packetIn.field_179772_d / 20L;
        ...
        if (s.startsWith("level://")) {
            ...
            if (file2.isFile()) {
                ...
                Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(file2), new FutureCallback<Object>(){
                    final /* synthetic */ NetHandlerPlayClient this$0;
                    {
                        this.this$0 = this$0;
                    }
                    ...
                    public void onSuccess(Object p_onSuccess_1_) {
                        this.this$0.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                    }

                    @Override
                    public void onFailure(Throwable p_onFailure_1_) {
                        this.this$0.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                    }
                });
            } else {
            ...
            this.gameController.addScheduledTask(new Runnable(){
                ...
                @Override
                public void run() {
                    this.this$0.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(){
                        ...
                        public void confirmClicked(boolean result, int id) {
                            ...
                            if (result) {
                                ...
                                this$0.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.ACCEPTED));
                                Futures.addCallback(this$0.gameController.getResourcePackRepository().downloadResourcePack(s, s1), new FutureCallback<Object>(){

                                    @Override
                                    public void onSuccess(Object p_onSuccess_1_) {
                                        this$0.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                                    }

                                    @Override
                                    public void onFailure(Throwable p_onFailure_1_) {
                                        this$0.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                                    }
                                });
                            } else {
                                if (this$0.gameController.getCurrentServerData() != null) {
                                ...
                                this$0.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.DECLINED));
                            }
