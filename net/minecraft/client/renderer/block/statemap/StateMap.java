...
extends StateMapperBase {
    ...
    protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
        ...
        Object s = this.name == null ? ((ResourceLocation)Block.blockRegistry.getNameForObject(state.getBlock())).toString() : this.name.getName((Comparable)map.remove(this.name));
        if (this.suffix != null) {
