...
IResourceManagerReloadListener {
    ...
    public boolean loadTexture(ResourceLocation textureLocation, ITextureObject textureObj) {
        ...
        try {
            ...
            logger.warn("Failed to load texture: " + String.valueOf(textureLocation), (Throwable)ioexception);
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        ...
        while (iterator3.hasNext()) {
            Map.Entry<ResourceLocation, ITextureObject> o;
            Map.Entry<ResourceLocation, ITextureObject> entry = o = iterator3.next();
    ...
    public void reloadBannerTextures() {
        ...
        while (iterator2.hasNext()) {
            Map.Entry<ResourceLocation, ITextureObject> o;
            Map.Entry<ResourceLocation, ITextureObject> entry = o = iterator2.next();
