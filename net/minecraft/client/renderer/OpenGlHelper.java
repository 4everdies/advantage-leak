...
public class OpenGlHelper {
    ...
    public static void glShaderSource(int shaderIn, ByteBuffer string) {
        ...
        if (arbShaders) {
            ARBShaderObjects.glShaderSourceARB(shaderIn, (CharSequence)src);
        } else {
            GL20.glShaderSource(shaderIn, (CharSequence)src);
        }
    }
    ...
    public static void glUniform1(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform1ivARB(location, values2);
        } else {
            GL20.glUniform1iv(location, values2);
        }
    }
    ...
    public static void glUniform1(int location, FloatBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform1fvARB(location, values2);
        } else {
            GL20.glUniform1fv(location, values2);
        }
    }

    public static void glUniform2(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform2ivARB(location, values2);
        } else {
            GL20.glUniform2iv(location, values2);
        }
    }

    public static void glUniform2(int location, FloatBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform2fvARB(location, values2);
        } else {
            GL20.glUniform2fv(location, values2);
        }
    }

    public static void glUniform3(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform3ivARB(location, values2);
        } else {
            GL20.glUniform3iv(location, values2);
        }
    }

    public static void glUniform3(int location, FloatBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform3fvARB(location, values2);
        } else {
            GL20.glUniform3fv(location, values2);
        }
    }

    public static void glUniform4(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform4ivARB(location, values2);
        } else {
            GL20.glUniform4iv(location, values2);
        }
    }

    public static void glUniform4(int location, FloatBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform4fvARB(location, values2);
        } else {
            GL20.glUniform4fv(location, values2);
        }
    }
