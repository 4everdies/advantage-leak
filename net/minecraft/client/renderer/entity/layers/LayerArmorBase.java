...
implements LayerRenderer<EntityLivingBase> {
    ...
    public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, int p_getArmorResource_3_, String p_getArmorResource_4_) {
        ...
        if ((resourcelocation = ARMOR_TEXTURE_RES_MAP.get(s2 = String.format("%s:textures/models/armor/%s_layer_%d%s.png", s1, s, this.isSlotForLeggings(p_getArmorResource_3_) ? 2 : 1, p_getArmorResource_4_ == null ? "" : String.format("_%s", p_getArmorResource_4_)))) == null) {
