...
extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (Advantage.INSTANCE.getModuleManager().getModule(ChamsModule.class).isEnabled() && ChamsModule.shouldRender(entity)) {
            GL11.glEnable(32823);
        ...
        try {
            ...
            float f2 = f1 - f;
            if (this.mainModel.isRiding && (entity2 = ((EntityLivingBase)entity).ridingEntity) instanceof EntityLivingBase) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        GL11.glTexEnvfv(8960, 8705, this.brightnessBuffer);
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (Advantage.INSTANCE.getModuleManager().getModule(NameTagsModule.class).isEnabled()) {
            return;
        }
