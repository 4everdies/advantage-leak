...
implements IProgressMeter {
    ...
    extends Stats {
        public StatsItem(Minecraft mcIn) {
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                final /* synthetic */ StatsItem this$1;
                {
                    this.this$1 = this$1;
                }
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                    ...
                    if (statbase != null || statbase1 != null) {
                        ...
                        int l = this.this$1.GuiStats.this.field_146546_t.readStat(statbase);
                        if (l != (i1 = this.this$1.GuiStats.this.field_146546_t.readStat(statbase1))) {
    ...
    extends Stats {
        public StatsBlock(Minecraft mcIn) {
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                final /* synthetic */ StatsBlock this$1;
                {
                    this.this$1 = this$1;
                }
