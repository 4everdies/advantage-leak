...
extends GuiScreen {
    ...
    public void initGui() {
        int i = this.width / 3;
        int j = i - 130;
        this.buttonList.add(new GuiButton(1, j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.timeout", new Object[0])));
        ...
        this.buttonList.add(new GuiButton(5, j / 2, this.height - 45, 130, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiTwitchUserMode.drawCenteredString(this.fontRendererObj, this.field_152338_i.getUnformattedText(), this.width / 2, 70, 0xFFFFFF);
        int i = 80;
        for (IChatComponent ichatcomponent : this.field_152332_r) {
