...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiStreamOptions.drawCenteredString(this.fontRendererObj, this.field_152319_i, this.width / 2, 20, 0xFFFFFF);
        GuiStreamOptions.drawCenteredString(this.fontRendererObj, this.field_152313_r, this.width / 2, this.field_152314_s, 0xFFFFFF);
        if (this.field_152315_t) {
            GuiStreamOptions.drawCenteredString(this.fontRendererObj, String.valueOf((Object)EnumChatFormatting.RED) + I18n.format("options.stream.changes", new Object[0]), this.width / 2, 20 + this.fontRendererObj.FONT_HEIGHT, 0xFFFFFF);
        }
