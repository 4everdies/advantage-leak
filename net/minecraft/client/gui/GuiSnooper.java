...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiSnooper.drawCenteredString(this.fontRendererObj, this.field_146610_i, this.width / 2, 8, 0xFFFFFF);
        int i = 22;
        for (String s : this.field_146607_r) {
            GuiSnooper.drawCenteredString(this.fontRendererObj, s, this.width / 2, i, 0x808080);
