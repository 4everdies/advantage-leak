...
implements GuiYesNoCallback {
    ...
    protected String func_146614_d(int p_146614_1_) {
        Object s = this.field_146639_s.get(p_146614_1_).getDisplayName();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiSelectWorld.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 20, 0xFFFFFF);
