...
IStream {
    ...
    public TwitchStream(Minecraft mcIn, final Property streamProperty) {
        ...
        if (streamProperty != null && !Strings.isNullOrEmpty(streamProperty.getValue()) && OpenGlHelper.framebufferSupported) {
            Thread thread2 = new Thread(this, "Twitch authenticator"){
                final /* synthetic */ TwitchStream this$0;
                {
                    this.this$0 = this$0;
                    super(arg0);
                }
                ...
                public void run() {
                    try {
                        ...
                        if (JsonUtils.getBoolean(jsonobject1, "valid")) {
                            ...
                            this.this$0.broadcastController.func_152818_a(s1, authtoken);
                            this.this$0.chatController.func_152998_c(s1);
                            this.this$0.chatController.func_152994_a(authtoken);
                            Runtime.getRuntime().addShutdownHook(new Thread("Twitch shutdown hook"){

                                @Override
                                public void run() {
                                    this$0.shutdownStream();
                                }
                            });
                            this.this$0.broadcastController.func_152817_A();
                            this.this$0.chatController.func_175984_n();
                        } else {
                            this.this$0.authFailureReason = IStream.AuthFailureReason.INVALID_TOKEN;
                            LOGGER.error(STREAM_MARKER, "Given twitch access token is invalid");
                        }
                    }
                    catch (IOException ioexception) {
                        this.this$0.authFailureReason = IStream.AuthFailureReason.ERROR;
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        ...
        this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new ChatComponentText("Issue streaming frame: " + String.valueOf((Object)p_152893_1_) + " (" + ErrorCode.getString(p_152893_1_) + ")"), 2);
    }
    ...
    private boolean func_176028_a(Set<ChatUserMode> p_176028_1_, Set<ChatUserSubscription> p_176028_2_, int p_176028_3_) {
        return !p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_BANNED) && (p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_ADMINSTRATOR) || p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_MODERATOR) || p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_STAFF) || p_176028_3_ == 0 || p_176028_3_ == 1 && p_176028_2_.contains((Object)ChatUserSubscription.TTV_CHAT_USERSUB_SUBSCRIBER));
    }
